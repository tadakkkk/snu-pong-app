...
export default function MagpieHappy({ size = 100 }: Props) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <rect x="6" y="5" width="2" height="1" fill="#191F28" />
      <rect x="9" y="5" width="2" height="1" fill="#191F28" />
      ...
      <rect x="2" y="6" width="2" height="4" fill="#5B8FE8" />
      <rect x="12" y="6" width="2" height="4" fill="#5B8FE8" />
