...
export const sites: Site[] = [
  ...
  },
  {
    ...
    category: "etc",
    name: "스누식단",
    url: "http://snuco.snu.ac.kr/foodmenu",
    description: "학생회관·자연대 식당 등 교내 식단 메뉴 확인. 오늘 뭐 먹을지 고민 해결.",
  },
  {
    id: "campus_shuttle",
    category: "etc",
    name: "학내교통 (셔틀버스)",
    url: "https://www.snu.ac.kr/about/gwanak/shuttles/campus_shuttles",
    description: "캠퍼스 순환버스·통근버스 시간표 및 노선 안내.",
  },
  {
    id: "scholarship_page",
    category: "scholarship_finance",
    name: "장학금·학자금 안내",
    url: "https://student.snu.ac.kr/%eb%8c%80%ed%95%99%ec%83%9d%ed%99%9c/%ec%9e%a5%ed%95%99/%ec%9e%a5%ed%95%99%ec%86%8c%ea%b0%9c/",
    description: "교내·교외 장학금 종류 및 신청 안내. 학자금 대출 정보 포함.",
  },
  {
    id: "it_services",
    category: "etc",
    name: "정보화서비스",
    url: "https://www.snu.ac.kr/campuslife/aid/it",
    description: "캠퍼스 Wi-Fi·소프트웨어 무료 배포(MS Office 등)·이메일 계정 안내.",
  },
  {
    id: "health_hospital",
    category: "health",
    name: "의료보건서비스",
    url: "https://www.snu.ac.kr/campuslife/aid/health/hospital1",
    description: "교내 보건진료소·학생건강보험·심리상담 등 의료·보건 서비스 통합 안내.",
  },
  {
    id: "amenities",
    category: "culture_facility",
    name: "편의시설",
    url: "https://www.snu.ac.kr/campuslife/facilities/amenities",
    description: "교내 식당·카페·편의점·ATM·복사실 등 편의시설 위치 안내.",
  },
  {
    id: "events_today",
    category: "etc",
    name: "행사·전시 (오늘)",
    url: "https://www.snu.ac.kr/snunow/events/today",
    description: "오늘 열리는 학내 행사·전시·강연 목록. 발품 팔지 않아도 놓치지 않는다.",
  },
  {
    id: "public_lecture",
    category: "culture_facility",
    name: "대중강연·문화행사",
    url: "https://www.snu.ac.kr/about/sharing-snu/public-lecture",
    description: "서울대 교수 무료 공개강연·문화행사 일정. 외부인도 청강 가능.",
  },
  {
    id: "ist",
    category: "etc",
    name: "정보화본부",
    url: "http://ist.snu.ac.kr/",
    description: "전산 계정 관리·학내 시스템 장애 공지·소프트웨어 라이선스 배포.",
  },
  {
    id: "ifs",
    category: "etc",
    name: "국가미래전략원",
    url: "https://ifs.snu.ac.kr/",
    description: "서울대 부설 연구원. 정책·국제 이슈 관련 공개 강연·세미나 개최.",
  },
];
